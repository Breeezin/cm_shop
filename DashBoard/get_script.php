<?php
   ...
   global $link;
	...
	foreach( $tables as $table )
	{
		...
		if( $keyname && $keyval )
			echo "mysqldump --default-character-set=latin1 --lock-tables=false --single-transaction --skip-opt --quick --complete-insert --no-create-info -ps3Are pe $table --where='where $keyname >= $keyval' > $table.sql\n";
