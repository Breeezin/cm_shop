<?php 
	...
	if( !$debug )
	{
		$smtp_relay_to_array[] = "polly@imelhk.com";
		$smtp_relay_to_array[] = "ravi@imelhk.com";
	}
	$smtp_relay_subject = "HK Packing Details from Bjorck Bros";
...
//		for forcing the sending of old packing detail files.
	if( array_key_exists('date', $_GET ) && (int)$_GET['date'] > 20100101 && (int)$_GET['date'] < 20300101 )
	{
		...
		$fullname_csv = "/tmp/HK$basename_csv";
		$fullname_pdf = "/tmp/HK$basename_pdf";
		$lines = 1;
	}
	else
	{
