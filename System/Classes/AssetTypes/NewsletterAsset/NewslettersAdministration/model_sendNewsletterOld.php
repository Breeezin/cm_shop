<?php
	...
	while ($recipient = $Q_Recipients->fetchRow()) {
		...
		if (ss_optionExists("Newsletter Use UTF8")) {
    		$mailer->build_params['html_charset']  = 'UTF-8';
    		$mailer->build_params['text_charset']  = 'UTF-8';
    		$mailer->build_params['head_charset']  = 'UTF-8';
		}
		...
		if (!$recipient['us_html_email']) {
			...
			$htmlMessage = str_replace('Â','&nbsp;',$htmlMessage);
