<?php
	...
	$updateOrders = query("select * from shopsystem_orders, transactions where tr_id = or_tr_id and or_id > 50114 and (or_paid is not null or or_paid_not_shipped is not null) and or_invoiced is null and or_reshipment is null" );

	while ($Order = $updateOrders->fetchRow())
	{
		echo "Updating order number ".$Order['or_id']."<br/>";
		flush( );
		ob_flush( );
