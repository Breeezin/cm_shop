<?php
	...
	$htmlMessage = $this->processTemplate('ExternalOrderSheet',$data);	
	...
	$mailer->setSubject("Order #".$this->ATTRIBUTES['ors_id']);
	$mailer->setHTML($htmlMessage);
//	$mailer->send(array('im@admin.com','macbjorck@mac.com', 'marilyn@qualityimporters.com'));				
