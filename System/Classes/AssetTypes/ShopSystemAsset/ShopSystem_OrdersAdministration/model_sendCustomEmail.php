<?php
	...
	$data = array_merge( $Order, array( 'Boxes' => $Boxes, 'phone' => $phone ) );

	$htmlMessage = processTemplate("Custom/ContentStore/Templates/acmerockets/Email/CustomEmail.html",$data);


	include_once( "System/Libraries/Rmail/Rmail.php" );
	$mailer = new Rmail();
	$mailer->setFrom($ShopCereal['AST_SHOPSYSTEM_ADMINEMAIL']);
	$mailer->setSubject("Order number ".$Order['or_tr_id']." at {$GLOBALS['cfg']['website_name']}");				
