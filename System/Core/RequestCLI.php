<?php
	...
	Class Request {
		...
		function Request($act,$parameters = array()) {
...
//echo " User info -> ";
//ss_DumpVar( $_SESSION['User'] );

//echo "loading ".$classes[$className]['directory']."/_".$classes[$className]['name'].".php"."\n";
...
//echo "\nCalling ".$services[$act]['method']." with parameters ";
//ss_DumpVar($parameters);
//echo "\nReturning ";
