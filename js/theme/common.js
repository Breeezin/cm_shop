...
/*      url: 'index.php?route=checkout/cart/add',	*/
      url: 'Shop_System/Service/UpdateBasket/Async/1',
      type: 'get',
...
/*      dataType: 'json',	*/
	  dataType: 'html',
			success: function(data) {
				...
				setTimeout(function () {
					$('#cart > button').html('<span class="pull-right"><i class="fa fa-shopping-cart"></i>&nbsp;<span id="cart-number">' + cartNumber + '</span><span id="cart-total">' + cartTotal + '</span></span>');
