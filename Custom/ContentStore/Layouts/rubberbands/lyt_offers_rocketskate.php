...
<body id="defaultlayout">
	...
	<h2>{[TitleImage]}</h2>
	<div class="curvybox stockalert boxshadow ">Add any of these products to your order for NO extra shipping cost</div>
	{[Content]}

<div class="offerscheckout" >
<a href="Shop_System/Service/Login" class="red-button curvybox">Proceed to Checkout</a>
</div>
	</div>
	</div>
		<!-- /content box -->	</div>
