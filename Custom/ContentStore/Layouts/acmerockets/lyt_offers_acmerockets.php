        ...
        <div class="main-columns container container-full">
          <div class="row">
            <div id="content" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              <div class="html">
                <h3>Add any of these products to your order for NO extra shipping cost</h3>
              </div>
              <div class="pull-left">
                <span class="product-block">
                  <p>No thanks, continue checkout</p>
                  <span class="cart">
                    <button class="btn btn-cart" title="Checkout" type="button" onclick="window.location='/Shop_System/Service/Login';">Checkout</button>
                  </span>
                </span>
              </div>
              ...
              {[Content]}
              <div class="html">If a box you wanted is out of stock, you can 
                <a href="Shop_System/Service/AddToWishList"> add it to your wishlist</a>. You will be emailed when stock arrives.
              </div>
            </div>
          </div>
        </div>
