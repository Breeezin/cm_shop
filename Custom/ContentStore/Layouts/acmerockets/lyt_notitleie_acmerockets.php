...
<body id="defaultlayout" class="notitle">
	<!-- top bar -->
	...
	<div class="line contentwrap">
        ...
        <div class="logo-wrap">
        <a href="/" id="logo-link"><img src="Custom/ContentStore/Layouts/acmerockets/Images/logo.png" alt="Acme Express Chilean Product Shop" width="206" height="190" border="0" /></a></div>
