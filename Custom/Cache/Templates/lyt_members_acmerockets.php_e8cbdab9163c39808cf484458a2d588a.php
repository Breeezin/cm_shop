          ...
          <div class="row">
            <div id="content" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              ...
              <!--div class="heading-detail">
                <h3><?php if (file_exists(expandPath('Custom/Tags/TitleImage.php'))) require('Custom/Tags/TitleImage.php'); else require('System/Tags/TitleImage.php'); ?></h3>
              </div -->
              <p>
                <h1>
                  <a href='/Members'><?php if (file_exists(expandPath('Custom/Tags/TitleImage.php'))) require('Custom/Tags/TitleImage.php'); else require('System/Tags/TitleImage.php'); ?><a/><!-- service here?  -->
                </h1>
              </p>
