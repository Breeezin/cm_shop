...
function mmLoadMenus() {
  if (window.mm_menu_0507142727_0) return;
	...
	?>
  mm_menu_0507142727_0.addMenuItem("New&nbsp;Item","window.open('index.php?act=Asset.Add','addAsset', 'width=300,height=<?php print(ss_HTMLEditFormat($data['AddPopupHeight'])); ?>')");
...
<?php if (file_exists(expandPath('Custom/Tags/BodyEnd.php'))) require('Custom/Tags/BodyEnd.php'); else require('System/Tags/BodyEnd.php'); ?>
</body>
</html>
